...
var checkMysqlTableExist_1 = require("../checkMysqlTableExist");
...
var migrate = /** @class */ (function () {
    ...
    migrate.prototype.handler = function () {
        return __awaiter(this, void 0, void 0, function () {
            var rollback;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rollback()];
                    case 1:
                        rollback = _a.sent();
                        if (rollback == null)
                            return [2 /*return*/];
    ...
    migrate.prototype.rollback = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    migrate.prototype.finally = function (argv) {
        var _a, e_1, _b, _c;
        var _d;
        return __awaiter(this, void 0, void 0, function () {
            var path, Migration, p, migrations, _e, migrations_1, migrations_1_1, migrate_1, Migration, name_1, m1, e_1_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        Migration = require(node_path("nolla-core/src/database/mysql/migrations/000000_migrations"));
                    ...
                    case 10:
                        ...
                        migrate_1 = _c;
                        Migration = require("".concat(p, "/").concat(migrate_1)).default;
                        name_1 = migrate_1.split(".");
                        name_1.pop();
                    ...
                    case 15:
                        m1 = require(node_path("nolla-core/src/database/mysql/migrations/000000_migrations"));
