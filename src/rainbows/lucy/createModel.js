...
var createModel = /** @class */ (function () {
    ...
    createModel.prototype.handler = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelName, tableName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modelName()];
                    case 1:
                        modelName = _a.sent();
                        if (modelName == null)
                            return [2 /*return*/];
    ...
    createModel.prototype.modelName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prompts({
                            ...
                            validate: function (value) {
                                if (value.trim().length < 1)
                                    return "Name of model is required";
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.modelName];
                }
            });
        });
    };
    createModel.prototype.tableName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prompts({
                            ...
                            validate: function (value) {
                                if (value.trim().length < 1)
                                    return "Name of database table is required";
                                if (!Number.isNaN(parseInt(String(value))) || !Number.isNaN(parseInt(String(value))))
                                    return "Invalid name!";
                                return true;
                            }
    ...
    createModel.prototype.finally = function (argv) {
        var _a, e_1, _b, _c;
        var _d;
        return __awaiter(this, void 0, void 0, function () {
            var path, p, m, models, _e, models_1, models_1_1, model, e_1_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        _e = true, models_1 = __asyncValues(models);
                        _f.label = 3;
                    case 3: return [4 /*yield*/, models_1.next()];
                    case 4:
                        if (!(models_1_1 = _f.sent(), _a = models_1_1.done, !_a)) return [3 /*break*/, 6];
                        _c = models_1_1.value;
                        _e = false;
                        try {
                            model = _c;
                    ...
                    case 8:
                        ...
                        if (!(!_e && !_a && (_b = models_1.return))) return [3 /*break*/, 10];
                    ...
                    case 13:
                        ...
                        return [4 /*yield*/, fs_1.default.promises
                                .readFile(node_path("nolla-core/src/template/model.template.txt"), "utf-8")
                                .then(function (t) {
